    ...
    <div className="min-h-screen selection:bg-blue-100 selection:text-[#0A2540]">
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="text-4xl font-bold text-[#0A2540] mb-8">Privacy Policy</h1>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <h2>Contact Us</h2>
            <p>
              If you have any questions about this Privacy Policy, please contact us at privacy@quizzyai.com.
            </p>
          </div>
        </div>
      </main>
