  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-slate-900 text-white">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        {/* Headline */}
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight mb-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        {/* Subtext */}
        <p className="max-w-2xl mx-auto text-lg text-slate-300 mb-12 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-150">
        ...
        <div className="relative max-w-5xl mx-auto mt-20 group">
          ...
          <div className="relative mx-auto w-[280px] md:w-[320px] aspect-[9/18.5] bg-slate-800 rounded-[3rem] p-3 shadow-2xl border-4 border-slate-700 animate-in zoom-in-95 duration-1000 transition-transform hover:scale-[1.02] cursor-default">
            ...
            <div className="w-full h-full bg-slate-900 rounded-[2.2rem] overflow-hidden relative">
              ...
              <div className="absolute top-4 left-6 text-[10px] font-bold text-slate-300">9:41</div>
            </div>
          </div>
            ...
            <div className="p-4 w-52 flex flex-col gap-3 bg-slate-800 text-white rounded-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="text-[10px] font-bold text-white">Agbor Eneke</div>
          ...
          <FloatingCard className="absolute top-[10%] right-[2%] md:right-[15%] hidden sm:flex" delay={0.3}>
            <div className="p-4 w-44 flex flex-col gap-2 bg-slate-800 text-white rounded-xl">
              <div className="flex justify-between items-center">
                <div className="text-[10px] font-bold text-white">Group Studies</div>
                <Calendar size={12} className="text-slate-400" />
              </div>
              <div className="text-[8px] text-slate-400">11:00 - 01:30</div>
              <div className="flex -space-x-2 mt-2">
                {[1,2,3,4].map(i => (
                  <img key={i} src={`https://picsum.photos/32/32?random=${i+10}`} className="w-6 h-6 rounded-full border-2 border-slate-900 bg-slate-700" />
                ))}
                <div className="w-6 h-6 rounded-full bg-slate-700 border-2 border-slate-900 flex items-center justify-center text-[8px] font-bold text-slate-400">+8</div>
              </div>
            </div>
          </FloatingCard>
